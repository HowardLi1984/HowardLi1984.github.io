...
Hi there! I am Hao Li (李昊 in Chinese), a final-year Ph.D. candidate in the School of Computer Science at Peking University, advised by [Prof. Li Yuan](https://scholar.google.com/citations?user=-5juAR0AAAAJ&hl=en) and [Prof. Yonghong Tian](https://scholar.google.com/citations?user=fn6hJx0AAAAJ&hl=en&oi=ao). Before that, I got my Bachelor degree in Computer Science at Peking University with a Summa Cum Laude.

My research interests include multimodal Learning, visual understanding, and AI for Chemical Science. I have published more than 20 papers at the top international AI conferences with total <a href='https://scholar.google.com/citations?user=y4va91AAAAAJ'> Google Scholar citations <strong><span id='total_cit'>2000+</span></strong></a>.
